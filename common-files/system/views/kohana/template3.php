...
<div id="header">
    ...
    <div id="header-content">
        ...
        <div class="add"><p><a href="/bin"><img alt="Корзина" src="/img.<?=$this->firm->template?>/icons/char.gif" /></a>
            Товаров: <span id="charCountItems"><?=$this->count_bin_items?></span> шт. <br />
            На сумму: <span id="charPriceItems"><?=$this->totalSum?></span>
        </p></div>


        <div class="phone-nam"><p>

            <img alt="Телефоны" src="/img.<?=$this->firm->template?>/icons/phoneLogo.gif" /> 

            <span class="phone-callback" id="phone-callback-block">
                <? if(empty($this->phone)) {?>

                        <a href="/" onclick="$('#callbackMessage').toggle(); return false;">Заказать обратный звонок</a>
